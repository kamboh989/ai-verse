...
type ContactInfoProps = React.ComponentProps<'div'> & {
	...
	label: string;
	value: string;
	href?: string; // added href for clickable links
};
	...
	return (
		...
		>
			...
			<div className="flex flex-col justify-between lg:col-span-2">
				<div className="relative h-full space-y-8 px-4 py-8 md:p-8">
	...
	return (
		<div className={cn('flex items-center gap-3 py-3', className)} {...props}>
			...
			<div>
				...
				{href ? (
					<a href={href} target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-sm hover:underline">
						{value}
					</a>
				) : (
