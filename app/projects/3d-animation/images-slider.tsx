import { BentoCell, BentoGrid, ContainerScale, ContainerScroll } from "@/app/projects/3d-animation/image-gallery";
  ...
  return (
    <ContainerScroll className="h-[350vh]">
      ...
      <ContainerScale className="relative z-10 text-center mt-28 md:mt-20">
        <h1 className="max-w-xl text-3xl md:text-5xl font-bold tracking-tighter text-gray-300 ">
         3D <span className="text-blue-400">Animation</span> Projects
        </h1>
        <p className="my-6 max-w-xl text-sm text-gray-300 md:text-base">
